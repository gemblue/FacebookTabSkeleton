	<div class="navbar navbar-fixed-top">
		<div class="navbar-inner">
				...
				<div class="nav-collapse collapse">
					<ul class="nav">
						<li class=""><a href="<?php echo site_url(); ?>" target="_blank">Apps : <?php echo (isset($site_title) ? $site_title : 'Tab-Igniter'); ?></a></li>
						<li class="divider-vertical"></li>
						<!--
						<li class=""><a href="<?php echo site_url('control/setting')?>"><i class="icon-cog right-space5"></i> Setting</a></li>
						-->
						<li class="divider-vertical"></li>
					</ul>
