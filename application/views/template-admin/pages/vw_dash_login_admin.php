...
<head>
	...
	body {
		...
		background:url(<?php echo base_url('application/views/template-admin/assets/img/wavegrid.png'); ?>) repeat;
	}
	.container {
		width:500px;
		margin:auto;
...
<div class="container" align="center">
	<div class="logo">
		<a href="<?php echo base_url(); ?>"><?php echo (!empty($logo_form_admin) ? '<img width="100" src="'.$logo_form_admin.'">' : 'Tab-Igniter'); ?></a>
	</div>

	<div class="login-box">
		<div style="margin-bottom:10px;"><?php echo $this->session->flashdata('message');?></div>
		<form id="form-login-area" method="POST" action="<?php echo site_url('auth/login'); ?>">
