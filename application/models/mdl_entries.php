...
{
	var $entries = 'tbl_entries';
	var $entries_meta = 'tbl_entrymetas';
	...
	*/
	function get_meta_information($post_type)
	{
		...
		this function returns array metas information that used by the post type
		*/
		$sql = "SELECT id FROM $this->entries WHERE post_type = '$post_type' ORDER BY id DESC LIMIT 1";
	...
	function get_list_post($post_type,$limit)
	{
		/*
		...
		*/
		...
		$this->db->where($this->entries.'.post_type',$post_type);
	...
	*/
	...
	|
	*/
	function update_post_master($field_name, $value, $entries_id)
	{
		/*
	...
	*/
	...
	|
	*/
	function update_post_meta($meta_key, $meta_name, $meta_value, $entries_id)
	{
		/*
	...
	function get_post_meta($entries_id, $field_value)
	{
		/*
		model to get post meta data
		*/
